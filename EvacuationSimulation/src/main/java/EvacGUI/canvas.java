...
public class canvas extends JComponent implements KeyListener,MouseMotionListener
{
    ...
    canvas()
    {
        ...
        b1=new My_box(0,0,500,10);
        b2=new My_box(0,0,10,500);
        b3=new My_box(0,0,220,10);
        b4=new My_box(0,0,220,10);
        b5=new My_box(0,0,10,500);
        b1.setLocation(0,0);
        b2.setLocation(500,0);
        b3.setLocation(0,500);
        b4.setLocation(290,500);
        b5.setLocation(0,0);
        addKeyListener(this);
    ...
    public void addBall(int size)
    {
    	...
    	temp_ball.x_pos=(int) (Math.random()*500%490);
    	temp_ball.y_pos= (int) (Math.random()*500%490);
